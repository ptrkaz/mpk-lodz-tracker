...
abstract class AppLocalizations {
  ...
  /// No description provided for @filterChipAll.
  ///
  /// In pl, this message translates to:
  /// **'Wszystkie linie'**
  String get filterChipAll;

  /// No description provided for @filterChipSome.
  ///
  /// In pl, this message translates to:
  /// **'{count, plural, one{{count} linia} few{{count} linie} many{{count} linii} other{{count} linii}}'**
  ...
  /// No description provided for @filterTabTram.
  ///
  /// In pl, this message translates to:
  /// **'Tramwaje'**
  String get filterTabTram;

  /// No description provided for @filterTabBus.
  ///
  /// In pl, this message translates to:
  /// **'Autobusy'**
  String get filterTabBus;
  ...
  /// No description provided for @mapLastUpdate.
  ///
  /// In pl, this message translates to:
  /// **'aktualizacja: {seconds}s temu'**
  ...
  ///
  /// In pl, this message translates to:
  /// **'Brak połączenia, ponawiam…'**
  String get mapOffline;

  /// No description provided for @markerTram.
  ///
  /// In pl, this message translates to:
  /// **'Tramwaj {number}'**
  String markerTram(String number);

  /// No description provided for @markerBus.
  ///
  /// In pl, this message translates to:
  /// **'Autobus {number}'**
  String markerBus(String number);

  /// No description provided for @markerUnknown.
  ///
  /// In pl, this message translates to:
  /// **'Linia {number}'**
  String markerUnknown(String number);

  /// No description provided for @markerAgo.
  ///
  /// In pl, this message translates to:
  /// **'{seconds}s temu'**
